...
// (DO NOT EDIT: machine generated header) 'Data.Bind.Components.pas' rev: 33.00 (Windows)
...
__interface DELPHIINTERFACE IScopeMemberDisplayNames;
typedef System::DelphiInterface<IScopeMemberDisplayNames> _di_IScopeMemberDisplayNames;
...
__interface  INTERFACE_UUID("{E79E5862-E1F2-4493-A642-5859A9D765D8}") IDependencyList  : public System::IInterface 
{
	...
	virtual void __fastcall Notify(System::TObject* ASender, System::Classes::TComponent* AComponent, const System::UnicodeString AValue) = 0 /* overload */;
	virtual void __fastcall Notify(System::TObject* ASender, System::Bindings::Evalprotocol::_di_ILocation ALocation, const System::UnicodeString AExpr) = 0 /* overload */;
	virtual void __fastcall Link(System::Classes::TComponent* AComponent, System::Bindings::Evalprotocol::_di_ILocation ALocation) = 0 ;
	virtual System::Classes::TComponent* __fastcall GetLink(System::Bindings::Evalprotocol::_di_ILocation ALocation) = 0 ;
	virtual void __fastcall ClearLink(System::Bindings::Evalprotocol::_di_ILocation ALocation) = 0 ;
};
...
public:
	...
	void __fastcall Link(System::Classes::TComponent* AComponent, System::Bindings::Evalprotocol::_di_ILocation ALocation);
	System::Classes::TComponent* __fastcall GetLink(System::Bindings::Evalprotocol::_di_ILocation ALocation);
	void __fastcall ClearLink(System::Bindings::Evalprotocol::_di_ILocation ALocation);
...
private:
	void __fastcall DesignAutoActivateOnPropertyChange();
...
__interface  INTERFACE_UUID("{B02AADEE-2F39-4A26-A17C-5A7B391647FD}") IScopeMemberDisplayNames  : public System::IInterface 
{
	virtual bool __fastcall GetMemberDisplayName(const System::UnicodeString AMemberName, /* out */ System::UnicodeString &ADisplayName) = 0 ;
};
