...
// (DO NOT EDIT: machine generated header) 'Data.Bind.ObjectScope.pas' rev: 33.00 (Windows)
...
private:
	System::Generics::Collections::TDictionary__2<System::UnicodeString,System::Rtti::TValue>* FDictionary;
	System::Generics::Collections::TList__1<System::TObject*>* FFreeObjects;
	
public:
	__fastcall TGeneratorRecord();
...
public:
#ifndef _WIN64
	__fastcall TTypedListValueGeneratorDelegate__1(TGeneratorOptions AOptions, System::DynamicArray<T> AValuesList);
#else /* _WIN64 */
	__fastcall TTypedListValueGeneratorDelegate__1(TGeneratorOptions AOptions, System::TArray__1<T> AValuesList);
#endif /* _WIN64 */
