...
// (DO NOT EDIT: machine generated header) 'System.Bindings.EvalProtocol.pas' rev: 33.00 (Windows)
...
{
	virtual System::Generics::Collections::TDictionary__2<System::_di_IInterface,void *>* __fastcall GetWrappers() = 0 ;
	__property System::Generics::Collections::TDictionary__2<System::_di_IInterface,void *>* Wrappers = {read=GetWrappers};
};
